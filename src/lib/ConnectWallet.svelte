...
<div class="container">
    <Card>
        ...
        <p>
            Welcome to the entrance of the most powerful Ethereum scaling solution, paving the way for unprecedented Blockchain based user experiences. Wield its power with responsibility. 
        </p>
